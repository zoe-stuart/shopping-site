...
products[0] = new Product("194790187", "Anti-Gravity Hat",  20.50);
products[1] = new Product("385780463", "Chinese Fortune Sticks",    9.99);
products[2] = new Product("570127405", "Decoy Detonator",  7.50);
products[3] = new Product("729487342", "Extendable Ears",  15.45);
products[4] = new Product("928489364", "Nose Biting Teacup",  23.20);
products[5] = new Product("119834978", "Sticky Trainers",  50.15);
products[6] = new Product("132847282", "Weather in a Bottle",  15.25);
products[7] = new Product("150387534", "Canary Creams",  7.25);
products[8] = new Product("170123875", "Chocolate Cauldrons",  15.75);
products[9] = new Product("192938575", "Jumping Snakes",  9.99);
products[10] = new Product("213489754", "Puking Pastilles",  .75);
products[11] = new Product("232284755", "Skiving Snackboxes",  25.45);
products[12] = new Product("252348574", "First Love Beguiling Bubbles",  20.00);
products[13] = new Product("271263453", "Patented Daydream Charms",  15.00);
products[14] = new Product("290987456", "Love is Blind Serum",  12.99);
products[15] = new Product("312309574", "Pygmy Puffs",  25.00);
products[16] = new Product("332037231", "Ten Second Pimple Vanisher",  .50);
...
var free_shipping_quota = 100.00     // applied if free_shipping_allowed, set to 0.00 for always free
